...
import $css_0 from 'Frontend/styles/views/currentticket/currentticket-view.css';
...
import $css_2 from 'Frontend/styles/views/addresult/addresult-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/styles/views/mybets/mybets-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_3}</style></custom-style>`);
import $css_4 from 'Frontend/styles/views/home/home-view.css';
...
import $css_6 from 'Frontend/styles/views/settings/settings-view.css';
...
import $css_8 from 'Frontend/styles/views/login/login-view.css';
