...
import $css_0 from 'Frontend/styles/views/settings/settings-view.css';
...
import $css_2 from 'Frontend/styles/views/wallet/wallet-view.css';
addCssBlock(`<custom-style><style>${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/styles/views/currentticket/currentticket-view.css';
...
import $css_5 from 'Frontend/styles/views/main/main-view.css';
addCssBlock(`<custom-style><style>${$css_5}</style></custom-style>`);
import $css_6 from 'Frontend/styles/views/admin/admin-view.css';
