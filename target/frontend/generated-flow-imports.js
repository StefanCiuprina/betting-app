...
import $css_1 from 'Frontend/styles/views/settings/settings-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_1}</style></custom-style>`);
import $css_2 from 'Frontend/styles/views/login/login-view.css';
addCssBlock(`<custom-style><style>${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/styles/views/wallet/wallet-view.css';
addCssBlock(`<custom-style><style>${$css_3}</style></custom-style>`);
import $css_4 from 'Frontend/styles/views/currentticket/currentticket-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_4}</style></custom-style>`);
import $css_5 from 'Frontend/styles/views/home/home-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_5}</style></custom-style>`);
import $css_6 from 'Frontend/styles/views/main/main-view.css';
addCssBlock(`<custom-style><style>${$css_6}</style></custom-style>`);
import $css_7 from 'Frontend/styles/views/mybets/mybets-view.css';
