...
import $css_2 from 'Frontend/styles/views/mybets/mybets-view.css';
...
import $css_4 from 'Frontend/styles/views/settings/settings-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_4}</style></custom-style>`);
import $css_5 from 'Frontend/styles/views/admin/admin-view.css';
